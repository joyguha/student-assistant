...
def Speak(audio):
    print(" ")
    Assistant.say(audio)
    print(f"JOLLY REPLY- {audio}")
    print("  ")
    Assistant.runAndWait()

#Speak('hello joy how are you')
...
def takecommand():
    ...
    with sr.Microphone() as source:
        ...
        return query.lower()
Speak("hello, I am jolly, your personal assistant. created by joy guha. how can i help you?")
...
def WhatsAppMsg(name, message):
    os.startfile("C:\\Users\\joyguha\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
    sleep(10)
...
def Task_doing():
    ...
    #wishing command
        if 'hello' in query or 'hey' in query:
            ...
            Speak("My name is Jolly. I am a chat bot. Created by Joy guha")
    ...
    #stoping commands for chat bot
        elif 'jolly stop' in query or 'stop' in query:
    ...
    #wikihow, ask any thing from jolly. This will scrap data from internet and give output
        elif 'how' in query:
    ...
    #open app function
            ...
            Speak("ok. opening")
            os.startfile("C:\\Users\\joyguha\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
